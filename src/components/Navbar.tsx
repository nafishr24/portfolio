...
import { Menu, X, ChevronDown, Instagram, Mail, Linkedin, Github } from 'lucide-react';
...
const Navbar = () => {
  ...
  const contactLinks = [
    ...
    { name: 'Email', icon: Mail, href: 'nafishusenromadani@gmail.com', color: 'hover:text-blue-500' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/nafishusen24/', color: 'hover:text-blue-600' },
    { name: 'GitHub', icon: Github, href: 'https://github.com/nafishr24/', color: 'hover:text-gray-700' },
  ];

  const getNavItemClass = (sectionId: string) => {
    return `text-gray-700 hover:text-blue-600 transition-colors font-medium ${
      activeSection === sectionId ? 'text-blue-600 font-semibold' : ''
    }`;
  };
        ...
        {isOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-lg rounded-lg mt-2 border shadow-lg">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              {/* Mobile Contact Section - Kept as dropdown */}
